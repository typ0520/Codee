...
data class ProjectPayload(
    ...
    companion object {
        val TYPE_NAME = "ProjectEvent"
    }
}

data class Project(
		val owner_url: String, //https://api.github.com/repos/baxterthehacker/public-repo
		val url: String, //https://api.github.com/projects/288065
		val columns_url: String, //https://api.github.com/projects/288065/columns
		val id: Int, //288065
		val name: String, //2017
		val body: String, //Roadmap for work to be done in 2017
		val number: Int, //10
