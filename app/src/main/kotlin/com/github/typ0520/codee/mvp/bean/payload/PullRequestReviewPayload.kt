...
import com.github.typ0520.codee.mvp.bean.Links
import com.github.typ0520.codee.mvp.bean.PullRequest
...
data class PullRequestReviewPayload(
    ...
    companion object {
        val TYPE_NAME = "PullRequestReviewEvent"
    }
}
...
data class Review(
		val id: Int, //2626884
		val user: User,
		val body: String, //Looks great!
		val submitted_at: String, //2016-10-03T23:39:09Z
		val state: String, //approved
		val html_url: String, //https://github.com/baxterthehacker/public-repo/pull/8#pullrequestreview-2626884
		val pull_request_url: String, //https://api.github.com/repos/baxterthehacker/public-repo/pulls/8
		val _links: Links
)
