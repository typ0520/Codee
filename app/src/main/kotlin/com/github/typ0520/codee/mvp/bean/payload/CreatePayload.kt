...
data class CreatePayload(
		val ref: String, //0.0.1
		val ref_type: String, //tag
		val master_branch: String, //master
		val description: String,
		val pusher_type: String, //user
		val repository: Repository,
		val sender: User
): Payload() {
    companion object {
        val TYPE_NAME = "CreateEvent"

		val REF_TYPE_REPOSITORY = "repository"
		val REF_TYPE_BRANCH = "branch"
		val REF_TYPE_TAG = "tag"
    }
}
