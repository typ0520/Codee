...
data class ReleasePayload(
		val action: String, //published
		val release: Release,
		val repository: Repository,
		val sender: User
): Payload() {
    companion object {
        val TYPE_NAME = "ReleaseEvent"
    }
}

data class Release(
		val url: String, //https://api.github.com/repos/baxterthehacker/public-repo/releases/1261438
		val assets_url: String, //https://api.github.com/repos/baxterthehacker/public-repo/releases/1261438/assets
		val upload_url: String, //https://uploads.github.com/repos/baxterthehacker/public-repo/releases/1261438/assets{?name}
		val html_url: String, //https://github.com/baxterthehacker/public-repo/releases/tag/0.0.1
		val id: Int, //1261438
		val tag_name: String, //0.0.1
		...
		val published_at: String, //2015-05-05T23:40:38Z
		val assets: List<Any>,
		val tarball_url: String, //https://api.github.com/repos/baxterthehacker/public-repo/tarball/0.0.1
		val zipball_url: String, //https://api.github.com/repos/baxterthehacker/public-repo/zipball/0.0.1
		val body: Any //null
)
