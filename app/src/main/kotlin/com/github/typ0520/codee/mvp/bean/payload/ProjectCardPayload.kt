 ...
 */
data class ProjectCardPayload (
		val action: String, //created
		val project_card: ProjectCard,
		val repository: Repository,
		val organization: Organization,
		val sender: User
): Payload() {
    companion object {
        val TYPE_NAME = "ProjectCardEvent"
    }
}

data class ProjectCard(
		val url: String, //https://api.github.com/projects/columns/cards/1266091
		val column_url: String, //https://api.github.com/projects/columns/515520
		val column_id: Int, //515520
		val id: Int, //1266091
		val note: Any, //null
		val creator: User,
		val created_at: String, //2017-09-27T23:37:43Z
		val updated_at: String, //2017-09-27T23:39:09Z
		val content_url: String //https://api.github.com/repos/baxterthehacker/public-repo/issues/2
)
