 ...
 */
data class ProjectColumnPayload(
		val action: String, //created
		val project_column: ProjectColumn,
		val repository: Repository,
		val organization: Organization,
		val sender: User
): Payload() {
	companion object {
	    val TYPE_NAME = "ProjectColumnEvent"
	}
}

data class ProjectColumn(
		val url: String, //https://api.github.com/projects/columns/515520
		val project_url: String, //https://api.github.com/projects/288065
		val cards_url: String, //https://api.github.com/projects/columns/515520/cards
		val id: Int, //515520
		val name: String, //High Priority
