...
data class PullRequest(
		...
		val title: String, //new-feature
		val body: String, //Please pull these awesome changes
		val assignee: User,
...
data class Head(
		val label: String, //new-topic
		val ref: String, //new-topic
