...
import com.github.typ0520.codee.mvp.bean.Deployment
 ...
 */
data class DeploymentStatusPayload(
		val deployment_status: DeploymentStatus,
		val deployment: Deployment,
		val repository: Repository,
		val sender: User
): Payload() {
	companion object {
		val TYPE_NAME = "DeploymentStatusEvent"
	}
}

data class DeploymentStatus(
		val url: String, //https://api.github.com/repos/baxterthehacker/public-repo/deployments/710692/statuses/1115122
		val id: Int, //1115122
		val state: String, //success
		val creator: User,
		val description: Any, //null
		val target_url: Any, //null
		val created_at: String, //2015-05-05T23:40:39Z
		val updated_at: String, //2015-05-05T23:40:39Z
		val deployment_url: String, //https://api.github.com/repos/baxterthehacker/public-repo/deployments/710692
		val repository_url: String //https://api.github.com/repos/baxterthehacker/public-repo
)
